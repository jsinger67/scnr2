...
scanner! {
    StringsInCommentsScanner {
        mode INITIAL {
            ...
            token r"[a-zA-Z_][a-zA-Z0-9_]*" => 10; // "Identifier"
            on 5 push STRING;
            on 6 enter COMMENT;
        }
        mode STRING {
...
```txt
Tokens found: 17
[0..2] tok 10 at 1:1-1:3: 'Id'
[2..3] tok 1 at 2:0-2:1: '\n'
[3..4] tok 5 at 2:1-2:2: '\"'
[4..27] tok 11 at 2:2-2:25: 'Text with escaped End\\\"'
...
[41..58] tok 11 at 3:13-3:30: 'String in Comment'
[58..59] tok 5 at 3:30-3:31: '\"'
[59..64] tok 8 at 3:31-3:36: ' and '
[64..65] tok 5 at 3:36-3:37: '\"'
[65..77] tok 11 at 3:37-3:49: 'String again'
