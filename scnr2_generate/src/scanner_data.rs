...
mod tests {
    ...
    fn test_parse_scanner_data() {
        ...
        assert_eq!(mode_initial_patterns[0].terminal_type, 1);
        assert_eq!(mode_initial_patterns[1].terminal_type, 2);
        assert_eq!(mode_initial_patterns[2].terminal_type, 3);
        assert_eq!(mode_initial_patterns[3].terminal_type, 4);
        assert_eq!(mode_initial_patterns[4].terminal_type, 8);
        assert_eq!(mode_initial_patterns[5].terminal_type, 9);
        assert_eq!(mode_initial_patterns[6].terminal_type, 10);
        assert_eq!(mode_initial_patterns[7].terminal_type, 11);
        assert_eq!(mode_initial_patterns[8].terminal_type, 12);
        assert_eq!(mode_initial_patterns[9].terminal_type, 13);
        assert_eq!(mode_initial_patterns[10].terminal_type, 14);
        ...
        assert_eq!(mode_string_patterns[0].terminal_type, 5);
        assert_eq!(mode_string_patterns[1].terminal_type, 6);
        assert_eq!(mode_string_patterns[2].terminal_type, 7);
        assert_eq!(mode_string_patterns[3].terminal_type, 8);
        assert_eq!(mode_string_patterns[4].terminal_type, 14);
